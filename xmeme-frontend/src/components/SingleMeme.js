    ...
    <div >
        <div className="card">
            ...
            <div className="card-body">
                ...
                <Link to={"/edit/" + props.meme._id} className="btn-sm btn-primary mr1" id="edit">Edit</Link>
                <Link to="#" className="btn-sm btn-danger" id="delete" onClick={() => props.deleteMeme(props.meme._id)}>Delete</Link>
